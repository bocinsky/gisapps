...
- [**Content**](/content/) ({{< fa fa-person-chalkboard >}}): This page contains the readings, slides, and lecture notes for the week.
- **Readings** ({{< fa fa-book >}}): This page brings you directly to the required readings for the day.
...
schedule <- schedule_raw %>% 
  ...
  mutate(var_content = ifelse(!is.na(content),
                              glue('<a href="{content}.qmd"><i class="fa-solid fa-person-chalkboard fa-lg"></i></a>'),
                              glue('<font color="#e9ecef"><i class="fa-solid fa-person-chalkboard fa-lg"></i></font>'))) %>%
  mutate(var_readings = ifelse(!is.na(readings),
                              glue('<a href="{content}.html#{readings}"><i class="fa-solid fa-book fa-lg"></i></a>'),
