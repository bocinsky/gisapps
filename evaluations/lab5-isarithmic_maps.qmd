...
1.	Review the [class lecture on interpolation](/apps/content/20240402-spatial_storytelling_III.html){target="_blank"} and the data sources listed on the **Proxies** tab in the original spreadsheet. What kind of data you are using here? How was the data created and what kind of interpolation method is best suited to it?
