...
1.	Go to the [National Historical Geographical Information System (NHGIS) data website](https://www.nhgis.org). Click on the Login link in the upper right and follow the instructions to create an account. Back on the homepage, click on the Get Data link beside Start Here. Set the Filters as follows by choosing the selection, and then clicking Submit:	
