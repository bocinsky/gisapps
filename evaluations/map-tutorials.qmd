...
**You are responsible for writing up the three free-choice map tutorials format detailed below (no write-up is required for the migration tutorial).** Each write-up is worth 50 points each and are graded as Excellent (50), Good (40), Fair (30), or Poor (20).
...
Please save your map tutorial write-up as a Microsoft Word document. Please give your map tutorial the file name in this format:<br><center>`[last name]_map-tutorial_[#].docx`<br></center>where `#` is the number of map tutorial you are turning in (i.e., 1, 2, 3). For example, my second tutorial would be `Bocinsky_map-tutorial_2.docx`.

## Due Dates
Map tutorial write-ups are due weekly after your second lab session. You are expected to complete the Migration tutorial (no write-up) the first week, and then a map tutorial per week for the following three weeks.

**Labs are due by 2:00 PM Mountain Time.** 

Here is a table of due dates:

|       | Wednesday Section | Thursday Section |
| :---        |    :----   |          :--- |
| Lab 1      | February 7       | February 8   |
| Lab 2   | February 14       | February 15   |
| Lab 3   | February 21       | February 22   |
