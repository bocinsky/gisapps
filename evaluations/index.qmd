...
All labs and map tutorials will be submitted into separate Microsoft Forms in **Microsoft Word format only**. (We will give you feedback using track changes in Word.) Please see the individual assignment pages for specific due dates and instructions.
