...
You will need to download the Lab 1 ArcPro package from here: [ModelBuilder.aprx](/apps/evaluations/ModelBuilder.aprx){target="_blank"}.

1. Use the [supplied ArcPro package](/apps/evaluations/ModelBuilder.aprx){target="_blank"} and add any other variable layers you would like. Work in a geographic coordinate system in the Feature Dataset, and then set a projection in the data frame.
