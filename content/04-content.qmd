...
Also, ESRI has a [review of scales of measurement](https://pro.arcgis.com/en/pro-app/latest/help/analysis/spatial-analyst/performing-analysis/values-and-what-they-represent.htm){target="_blank"} as part of its [documentation on the Spatial Analyst tools](https://pro.arcgis.com/en/pro-app/latest/help/analysis/spatial-analyst/basics/what-is-the-spatial-analyst-extension.htm){target="_blank"}.
