...
<!-- - Geodatabases (and friends!) -->
 ...
 The [slides for today](/slides/VanDyke_et_al_Navajo.pdf){target="_blank"} are available online as an PDF file.

<object data="/slides/VanDyke_et_al_Navajo.pdf" type="application/pdf" width="100%" height="500px">
<p>Unable to display PDF file. <a href="/slides/VanDyke_et_al_Navajo.pdf">Download</a> instead.</p>
</object>
