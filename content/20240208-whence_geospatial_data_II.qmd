---
title: "Whence Geospatial Data II: (Mis)Placing things"
date: "2024-02-08"
---
...
slide_buttons("/slides/20240208-whence_geospatial_data_II")
# slide_tabs(slide_details, "/slides/01-slides.html")
```

```{r show-slides-xaringan, echo=FALSE}
xaringanExtra::embed_xaringan(
  url = "/slides/20240208-whence_geospatial_data_II.html",
  ratio = "16:9"
)
```
